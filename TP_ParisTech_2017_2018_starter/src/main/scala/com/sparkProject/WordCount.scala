...
object WordCount {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df_wordCount = sc.textFile("/Users/TheoAndro/Downloads/README.md")
    ...
    val df_wordCount_light = sc.textFile("/Users/TheoAndro/Downloads/README.md")
    ...
    val df_wordCount_lighter = sc.textFile("/Users/TheoAndro/Donwloads/README.md") // output RDD of lines : RDD[String]
    ...
    val df_wordCount_lightest = sc.textFile("/Users/TheoAndro/Downloads.7/README.md")
      .flatMap(_.split(" "))
      .map((_, 1))
      .reduceByKey(_ + _)
      .toDF("word", "count")
